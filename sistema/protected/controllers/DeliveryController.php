...
class DeliveryController extends Controller
{
	...
	public function actionView($id)
	{
		...
		$idpedido = Delivery::model()->findBySql('select * from Despacho where id = '.intval($id))->idPedido;		
		$tipo = Pedido::model()->findBySql('select * from Pedido where id='.$idpedido)->pagaCon;
		
		if($tipo == 'punto'){			
			$vista = '/pedido/viewcanje';				
		}else{			
			$vista = '/pedido/view';			
		}
		
		$this->render($vista,array(
			'model'=>$this->loadModelPedido($idpedido),
		));
	...
	public function loadModelPedido($id)
	{
