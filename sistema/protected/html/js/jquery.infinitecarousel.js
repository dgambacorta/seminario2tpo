	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				//html = '<div id="btn_rt'+randID+'" style="position:absolute;right:0;top:'+((imgHeight/2)-15)+'px"><a href="javascript:void(0);"><img style="border:none;margin-right:2px" src="/js/images/rt.png" /></a></div>';
				
								html = '<div id="btn_rt'+randID+'" style="position:absolute;right:0;top:'+((imgHeight/2)-15)+'px"><a href="javascript:void(0);"></a></div>';
				
				
				//html += '<div id="btn_lt'+randID+'" style="position:absolute;left:0;top:'+((imgHeight/2)-15)+'px"><a href="javascript:void(0);"><img style="border:none;margin-left:2px" src="/js/images/lt.png" /></a></div>';
				...
				//html = '<a href="javascript:void(0);"><img id="pause_btn'+randID+'" src="/js/images/pause.png" style="position:absolute;top:3px;right:3px;border:none" alt="Pause" /></a>';
				html = '<a href="javascript:void(0);"></a>';
				
				html += '<a href="javascript:void(0);"><img id="play_btn'+randID+'" src="/js/images/play.png" style="position:absolute;top:3px;right:3px;border:none;display:none;" alt="Play" /></a>';
				$(obj).append(html);
				...
				if(o.displayThumbnails)
				{
					...
					$(obj).after('<div id="thumbs'+randID+'" style="position:relative;overflow:auto;text-align:left;padding-top:5px;margin-left:90px;"></div>');
				...
				function showminmax()
				{
						if(!autopilot)
						{
							html = '<img style="position:absolute;top:2px;right:18px;display:none;cursor:pointer" src="/js/images/down.png" title="Minimize" alt="minimize" id="min" /><img style="position:absolute;top:2px;right:18px;display:none;cursor:pointer" src="/js/images/up.png" title="Maximize" alt="maximize" id="max" />';
							html += '<img style="position:absolute;top:2px;right:6px;display:none;cursor:pointer" src="/js/images/close.png" title="Close" alt="close" id="close" />';
