...
class Promocion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, fechaDesde, fechaHasta, cantidadPuntos', 'required'),
			array('cantidadPuntos', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>80),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nombre, fechaDesde, fechaHasta, cantidadPuntos', 'safe', 'on'=>'search'),
		);
	}
